...
public interface ReplyRepository extends JpaRepository<Reply, Long> {
    ...
    @Query("select new com.project.apiserver.reply.dto.ReplyDTO(r.rno, r.reply, r.ord, r.delFlag,  r.member.email, r.member.nickname, r.board.bno, r.regDate, r.modDate) from Reply r left join MemberAccount m on m.email = r.member.email where r.board.bno = :bno and r.delFlag = false group by  r.rno order by r.ord asc")
